...
[http://pad.software-carpentry.org/2018-03-20-dundee](http://pad.software-carpentry.org/2018-03-20-dundee)
...
* `data.frame`s are `list`s so subset like lists
...
Can you write a single line (which may span multiple lines in your script by including pipes) to produce a dataframe containing:
